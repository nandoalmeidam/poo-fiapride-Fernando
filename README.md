...
Se eu pudesse refazer o projeto, talvez escolheria um objeto mais próximo do cotidiano, como uma pessoa, animal ou sistema mais completo de cadastro, porque acredito que seria mais fácil expandir as funcionalidades. Também adicionaria mais interações entre as classes e criaria novas funcionalidades para deixar o projeto mais dinâmico e próximo de uma aplicação real. Outra melhoria seria organizar ainda mais a estrutura do código, separando melhor algumas responsabilidades entre as classes. Mesmo assim, o projeto do smartwatch me ajudou bastante a entender os principais conceitos de Programação Orientada a Objetos na prática.
